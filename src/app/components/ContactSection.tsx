...
function BarkWidget() {
  ...
  return (
    <a
      ...
      data-version="3.0"
    >
      <img src="/images/bark icon2.png" alt="Bark" className="w-11 h-11" />
...
export function ContactSection() {
  ...
  const BarkIcon = ({ size = 20, className = "" }: { size?: number; className?: string }) => (
    <svg
      ...
      className={className}
    >
      <img src="/images/bark icon2.png" alt="Bark" className="w-15 h-15" />
    </svg>
  );
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
const response = await fetch('https://backend-liard-alpha-57.vercel.app/api/contact', {
        method: 'POST',
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-white/80" style={{ fontFamily: 'var(--font-secondary)' }}>2093 Philadelphia Pike Claymont, DE 19703, USA</div>
                  </div>
                </div>
              </div>
            </div>
