  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Divout builds custom websites, POS systems, and SaaS solutions for restaurants and retail businesses. Web development agency specializing in React, Next.js, and scalable software." />        <meta property="og:title" content="Divout - Next-Gen Digital Agency" />
